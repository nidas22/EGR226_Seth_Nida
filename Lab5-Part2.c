...
* Project: Lab 5
* File: Lab5Part2.c
* Description: This programs purpose is to cycle through the three LEDs from green to
* yellow to red and back again to green for as long as the user holds the button
* down.
**************************************************************************************/
